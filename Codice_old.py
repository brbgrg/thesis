...
def combined_graph(sc_matrix, fc_matrix):
    ...
    for i in range(num_subjects):
        ...
        data = Data(x=sc_node_features, edge_index = edge_index, edge_attr = edge_weights)
...
# Create labeled graph set 

C = []

for label, graph_list in graphs.items():
    for i in range(5):
        C.append((graph_list[i], label))
